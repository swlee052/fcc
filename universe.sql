...
COPY public.comet (comet_id, name, description) FROM stdin;
1	c1	test
2	c2	test
3	c3	test
\.
...
COPY public.galaxy (galaxy_id, name, size, age, is_active) FROM stdin;
1	test1	10	10	t
2	test2	10	10	t
3	test3	10	10	t
4	test4	10	10	t
...
COPY public.moon (moon_id, name, planet_id, distance_from_planet, is_tidal_locked) FROM stdin;
1	m1	1	\N	\N
2	m2	2	\N	\N
3	m3	3	\N	\N
4	m4	4	\N	\N
...
COPY public.planet (planet_id, name, star_id, distance_from_star, has_life) FROM stdin;
1	p1	1	\N	\N
2	p2	2	\N	\N
3	p3	3	\N	\N
4	p4	4	\N	\N
...
COPY public.star (star_id, name, galaxy_id, temperature, mass, is_blackhole) FROM stdin;
1	star1	1	\N	\N	\N
2	star2	2	\N	\N	\N
3	star3	3	\N	\N	\N
4	star4	4	\N	\N	\N
